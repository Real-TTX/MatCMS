...
/// <summary>
/// Second step of a two-factor login: the password was already verified by <see cref="LoginModel"/>,
/// which parked the pending identity in the <see cref="TwoFactorLoginCookie"/> and redirected here.
/// Turns a valid authenticator code (or a recovery code) into the real session. Anonymous and
/// rate-limited exactly like the password form.
/// </summary>
[AllowAnonymous]
