...
// it has to be named — either a specific one via MatCmsCloud:Proxy:Known, or the whole private
// network by setting MatCmsCloud:Proxy:TrustAll. Trust-all belongs to a container that is
